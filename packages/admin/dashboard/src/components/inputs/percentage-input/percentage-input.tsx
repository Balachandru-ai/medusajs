...
export const PercentageInput = forwardRef<
  ElementRef<"input">,
  ComponentProps<typeof Primitive> & { bypassDefaultDecimalScale?: boolean }
>(
  (
    {
      min = 0,
      decimalScale = 2,
      decimalsLimit,
      bypassDefaultDecimalScale = false,
      value,
      className,
      ...props
    },
    ...
    return (
      <div className="relative">
        <Primitive
          ...
          min={min}
          autoComplete="off"
          decimalScale={bypassDefaultDecimalScale ? undefined : decimalScale}
          decimalsLimit={decimalsLimit || decimalScale}
          value={value}
          {...props}
          className={clx(
