...
const facts = [
  ...
  "Medusa provides a Claude Code plugin to facilitate your development. /plugin marketplace add medusajs/medusa-claude-plugins\n\n /plugin install medusa-dev@medusa",
  ...
  "Medusa is optimized to build custom commerce software with AI agents through its MCP server and Claude Code plugins.",
]
