...
import { addImageToVariantsStep } from "#product/steps/add-image-to-variants"
import { removeImageFromVariantsStep } from "#product/steps/remove-image-from-variants"
