...
/**
 * Extended interface for providers that support event priority.
 * Priority allows certain events to be processed before others.
 *
 * @example
 * ```ts
 * class MyRedisEventProvider implements IEventProviderWithPriority {
 *   // ...
 ...
 * ```
 */
export interface IEventProviderWithPriority extends IEventProvider {
  /**
...
/**
 * Extended interface for providers that support retry configuration.
 * Retry allows failed event handlers to be retried automatically.
 *
 * @example
 * ```ts
 * class MyRedisEventProvider implements IEventProviderWithRetry {
 *   // ...
 ...
 * ```
 */
export interface IEventProviderWithRetry extends IEventProvider {
  /**
