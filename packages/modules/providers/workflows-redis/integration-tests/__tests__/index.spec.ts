...
const providerId = "workflows-redis"

moduleIntegrationTestRunner<
  IWorkflowEngineService & {
    workflowOrchestratorService_: IDistributedTransactionStorage
  }
>({
  moduleName: Modules.WORKFLOW_ENGINE,
  resolve: path.resolve(__dirname, "../../../../workflows/dist"),
  moduleOptions: {
    providers: [
      {
        id: providerId,
  ...
  testSuite: ({ service: workflowOrcModule, medusaApp }) => {
    ...
    let workflowOrchestratorService: {
      storage_: IDistributedTransactionStorage
    }
    let storage: IDistributedTransactionStorage
    ...
    describe("Workflow Orchestrator module", function () {
      beforeEach(async () => {
        ...
        workflowOrchestratorService =
          workflowOrcModule.workflowOrchestratorService_ as unknown as {
            storage_: IDistributedTransactionStorage
          }
        storage = workflowOrchestratorService.storage_
      })
