...
/**
 * Provider config type for the Redis Workflows Provider.
 *
 * The workflow provider uses three queues internally:
 ...
 * ```
 */
export type WorkflowsRedisOptions = {
  /**
...
declare module "@medusajs/types" {
  interface ModuleProviderOptions {
    "@medusajs/workflows-redis": WorkflowsRedisOptions
    "@medusajs/medusa/workflows-redis": WorkflowsRedisOptions
  }
}
