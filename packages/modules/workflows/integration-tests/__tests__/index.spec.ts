...
moduleIntegrationTestRunner<
  IWorkflowEngineService & {
    workflowOrchestratorService_: IWorkflowModuleOrchestratorService
  }
>({
  ...
  testSuite: ({ service: workflowOrcModule, medusaApp }) => {
    describe("Workflow Orchestrator module", function () {
      ...
      let workflowOrchestratorService: IWorkflowModuleOrchestratorService & {
      ...
      beforeEach(() => {
        ...
        workflowOrchestratorService =
          workflowOrcModule.workflowOrchestratorService_ as unknown as IWorkflowModuleOrchestratorService & {
            storage_: IDistributedTransactionStorage
          }
