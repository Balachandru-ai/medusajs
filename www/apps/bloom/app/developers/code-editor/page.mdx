...
Access your project's source code directly in Bloom with the built-in Code Editor. Inspect implementations, make quick fixes, and understand how Bloom builds features.
...
The Code Editor feature is designed for quick edits and code inspection. Use it to make small changes, fix bugs, or review how Bloom implemented features.
...
To access the Code Editor in a Bloom project, click the **Code** tab at the top of the preview.
