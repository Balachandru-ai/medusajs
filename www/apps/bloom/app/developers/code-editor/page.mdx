...
To access the <InProductAction product={"bloom"} type={"MEDUSA_AI_OPEN_PANE"} data={{ pane: "developer" }}>Code Editor</InProductAction> in a Bloom project, click the **Code** tab at the top of the preview.
