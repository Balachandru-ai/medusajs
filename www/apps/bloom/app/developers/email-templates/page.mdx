...
Then, in your Bloom project's interface, click on "Emails" at the top of the preview. This will open the email previewer where you can switch between your email templates and see how they look with demo data.
