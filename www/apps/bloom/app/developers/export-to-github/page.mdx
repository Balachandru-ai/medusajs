import { CardList, Prerequisites, InProductAction } from "docs-ui"
...
To export your Bloom project to GitHub, click the <InProductAction product={"bloom"} type={"MEDUSA_AI_OPEN_PANE"} data={{ pane: "github" }}>**GitHub**</InProductAction> tab at the top of the preview. This will take you to the GitHub integration page where you can connect your GitHub account and transfer your repository.
