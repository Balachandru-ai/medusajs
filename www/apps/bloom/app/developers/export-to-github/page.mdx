...
To export your Bloom project to GitHub, click the "GitHub" tab at the top of the preview. This will take you to the GitHub integration page where you can connect your GitHub account and transfer your repository.
...
1. When you ask for a feature or change, Bloom creates a new branch with an auto-generated name matching the feature Bloom is building (e.g. `add-product-reviews-feature`).
