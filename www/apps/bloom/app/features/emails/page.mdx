...
To preview the email templates that Bloom creates for your store, click the <InProductAction product={"bloom"} type={"MEDUSA_AI_OPEN_PANE"} data={{ pane: "emails" }}>Emails</InProductAction> tab at the top of the project preview.
