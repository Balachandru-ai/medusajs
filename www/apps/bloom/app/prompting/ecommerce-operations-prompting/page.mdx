...
Bloom may misunderstand your instructions, so it's important to review the changes it made in your [store](../../features/mode-switcher/page.mdx#store-mode) and [admin dashboard](../../features/mode-switcher/page.mdx#admin-mode). This way, you can catch any errors early and ask Bloom to fix them if needed.
