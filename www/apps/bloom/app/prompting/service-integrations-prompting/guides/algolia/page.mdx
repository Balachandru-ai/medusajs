...
Bloom stores your Algolia credentials as environment variables in your store. They are never exposed in your code or logs. See [Environment Variables](#) for more details.
