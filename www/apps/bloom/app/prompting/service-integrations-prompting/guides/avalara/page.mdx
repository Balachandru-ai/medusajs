...
When you're ready to publish, Bloom will ask for live Avalara credentials.

Use the same credentials but change App Environment to `production`. It was `sandbox` for testing.

After publishing, your store will calculate real taxes through Avalara.
