...
When you're ready to publish, Bloom will ask for your live ShipStation API key. If you have different keys for testing and production, enter the production key.

After publishing, your store will sync orders to ShipStation and show real shipping rates at checkout.
