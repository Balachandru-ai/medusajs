...
- `@mikro-orm/*` packages (e.g., `@mikro-orm/core`, `@mikro-orm/migrations`, etc.) -> `@medusajs/framework/mikro-orm/{subpath}`
...
- `@mikro-orm/*` packages (e.g., `@mikro-orm/core`, `@mikro-orm/migrations`, etc.)
- `awilix`
- `pg`
