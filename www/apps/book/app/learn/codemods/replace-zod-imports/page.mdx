export const metadata = {
  title: `${pageNumber} Replace Zod Imports Codemod (v2.12.6+)`,
}

# {metadata.title}

In this chapter, you'll learn about the codemod that helps you replace Zod imports in your codebase when upgrading to Medusa v2.12.6.

## What is the Replace Zod Imports Codemod?

As of [v2.12.6](https://github.com/medusajs/medusa/releases/tag/v2.12.6), Medusa exports [Zod](https://zod.dev/) from the `@medusajs/framework` package.
...
Starting in v2.12.6, you can import Zod from `@medusajs/framework/zod` in your backend customizations. For example:
...
The `replace-zod-imports` codemod automates the process of updating your import statements to use the new Zod import path. Use it after updating your Medusa project to v2.12.6 or later.

---

## How to Run the Codemod

To use the replace imports codemod, update your Medusa project to v2.12.6 or later. Refer to the [Update Medusa](../../update/page.mdx) guide for instructions.
