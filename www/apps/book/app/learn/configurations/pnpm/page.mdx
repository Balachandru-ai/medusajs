...
As of [Medusa v2.12.6](https://github.com/medusajs/medusa/releases/tag/v2.12.6), new Medusa projects support `pnpm`. You can create a new Medusa project with `pnpm` using the following command:
...
If you're using a Medusa version prior to v2.12.6, you should update to the latest version to ensure compatibility with `pnpm`.

Refer to the [Update Medusa](../../update/page.mdx) guide to learn how to update your Medusa project.

If you're updating to v2.12.6, you also need to run the [replace-zod-imports codemod](../../codemods/replace-zod-imports/page.mdx).
