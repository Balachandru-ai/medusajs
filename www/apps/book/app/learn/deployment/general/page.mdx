...
By default, your Medusa application uses modules and providers useful for development, such as the In-Memory Caching Module Provider or the Local File Module Provider.

It’s highly recommended to instead use modules and providers suitable for production, including:

- [Redis Caching Module](!resources!/infrastructure-modules/caching/redis)
