...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      `ADMIN_AUTH_TYPE` ([v2.11.4+](https://github.com/medusajs/medusa/releases/tag/v2.11.4))
    ...
    <Table.Row>
      ...
      `ADMIN_JWT_TOKEN_STORAGE_KEY` ([v2.11.4+](https://github.com/medusajs/medusa/releases/tag/v2.11.4))
