...
The cache tag must follow the [Caching Tags Convention](!resources!/infrastructure-modules/caching#caching-tags-convention) to be automatically invalidated.
