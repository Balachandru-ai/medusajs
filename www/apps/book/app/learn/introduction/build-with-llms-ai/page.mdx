...
Medusa provides [Claude Code plugins](https://github.com/medusajs/medusa-agent-skills) to assist you in learning and building with Medusa.

If you use Claude Code, our team recommends installing these plugins to enhance your development experience with Medusa.

<Note>

For usage with other AI tools, see the [Use Claude Code Plugins with Other AI Tools](#use-claude-code-plugins-with-other-ai-tools) section.
...
The Claude Code plugins include skills and MCP server configurations. These features are also available in other AI tools like Cursor.

So, if you don't use Claude Code, you can install the skills with the [skills](https://skills.sh/) command, or copy the plugin's assets manually to your AI tool's configuration directories.
...
The `skills` command only copies skill files. So, if you want to use the MCP server configurations, you'll need to copy them manually as explained in the next section.

#### Copy Manually

You can also copy the skills and MCP server configurations manually to your AI tool's configuration directories. This is useful if your AI tool is not supported by the skills command, or you want to copy everything, not just specific skills.

To do this, refer to the documentation of your AI tool on where to place skills and MCP server configurations. Then, copy the relevant files from the [medusa-agent-skills repository](https://github.com/medusajs/medusa-agent-skills) to those directories.

For example, if you're using Cursor and you want to use the `medusa-dev` plugin, you can:

1. Copy the [skills directories](https://github.com/medusajs/medusa-agent-skills/tree/main/plugins/medusa-dev/skills) to the `.cursor/skills` directory of your Medusa project.
...
The AI Assistant in the docs is different from [Bloom](https://bloom.medusajs.com/), our AI-powered commerce assistant. This AI Assistant is specifically designed to help you with Medusa development by providing relevant documentation links, code snippets, and explanations.
