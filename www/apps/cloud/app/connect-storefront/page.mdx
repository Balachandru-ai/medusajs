...
## Cloud and External Storefront Hosting Overview

Medusa provides [storefront deployment](../storefront/page.mdx) alongside your Medusa application on Cloud. By deploying your storefront with Cloud, Medusa automatically handles the necessary configurations to connect your storefront to your Medusa application.

You can also host your storefront with an external provider, such as Vercel or Netlify. You may need this setup if:

1. Your storefront isn't part of a monorepo with your Medusa application.
2. You want to use an account with an external provider to manage your storefront hosting.

If you're using the [Next.js Starter Storefront](!resources!/nextjs-starter), you can follow the [Deploy to Vercel](!resources!/deployment/storefront/vercel) guide to deploy your storefront externally.
