...
In this guide, you'll learn how to access your Medusa Cloud [deployment](../page.mdx) for an environment.
...
2. Your existing Medusa Cloud account by clicking the "Log in with Medusa Cloud" button. A user will be created in the Medusa application with the same email as your Medusa Cloud account.

<Note>

Your Medusa application must be using Medusa [v2.12.4](https://github.com/medusajs/medusa/releases/tag/v2.12.4) or later to have the "Log in with Medusa Cloud" option.
