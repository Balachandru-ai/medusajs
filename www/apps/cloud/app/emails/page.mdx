...
### Remove Other Notification Module Providers

Medusa enables Medusa Emails by default for all Cloud projects if you haven't configured a [Notification Module Provider](!resources!/infrastructure-modules/notification) in your Medusa application.
