...
1. Your Medusa Cloud account by clicking the "Log in with Medusa Cloud" button. A user will be created in the Medusa application with the same email as your Medusa Cloud account.
