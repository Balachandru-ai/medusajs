...
Yes, Medusa supports deploying storefronts alongside your Medusa application on Cloud. It's currently a beta feature available for select users.

Learn more in the [Storefront Deployment on Cloud](../storefront/page.mdx) guide.
