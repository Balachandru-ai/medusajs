...
- **Server, Admin, and Storefront Hosting**: Host your Medusa server, admin, and [storefront](./storefront/page.mdx) with Cloud with zero configuration and automatic environment setup.
