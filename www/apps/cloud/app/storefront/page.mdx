...
Similar to the Medusa backend, Medusa deploys separate instances of your storefront for every long-lived and preview environment, based on your plan's limits. This allows you to test and preview changes in isolation.
