...
Usage over your plan limits is considered flex usage. For example, if your plan allows for 100GB data transfer, any usage beyond that limit would be classified as flex usage.
