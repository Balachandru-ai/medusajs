...
In this guide, you'll learn about the Draft Orders Plugin, its features, and how to install it.

<Note>

The Draft Orders Plugin was initially only available to Medusa Cloud users during its early access phase. It is now generally available for all Medusa users.
