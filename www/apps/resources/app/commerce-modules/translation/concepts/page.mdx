...
The Translation Module doesn't enforce a default locale. However, the [Store Module](#) has data models with default locale configurations that allow you to set the default locale for your store.

{/* TODO: add link */}

Learn more in the [Store Module Locales](#) guide.
