...
Learn more in the [Locales](#) storefront guide.
...
- The `Content-Language` header in the API request.
- The default locale of the store defined in the Store Module.

If translations aren't available for the selected locale, or no locale is selected, the default content of the resource is returned.
...
If you don't specify a locale when creating the cart, the default product content is used for the items in the cart.
