...
Authenticating into the Medusa Admin with third-party providers is supported from [Medusa v2.11.4](https://github.com/medusajs/medusa/releases/tag/v2.11.4).
