...
The In-Memory Cache Module is deprecated starting from [Medusa v2.11.0](https://github.com/medusajs/medusa/releases/tag/v2.11.0). Use the [In-Memory Caching Module Provider](../caching/providers/in-memory/page.mdx) instead.
