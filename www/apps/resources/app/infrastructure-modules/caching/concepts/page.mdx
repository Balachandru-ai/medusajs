...
When you cache data with the Query or Index Module, the Caching Module automatically generates cache tags based on the entity being queried and its relations.
