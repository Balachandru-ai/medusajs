...
If you support [localization](../../localization/page.mdx) in your storefront, you can set the locale to retrieve product information and other resources based on the customer's preferred language.
