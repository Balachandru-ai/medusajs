...
3. Set the Medusa application's publishable API key in the `NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY` environment variable. You can retrieve the publishable API key on the Medusa Admin dashboard by going to Settings -> Publishable API Keys
