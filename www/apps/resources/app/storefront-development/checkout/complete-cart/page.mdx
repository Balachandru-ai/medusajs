...
If no locale was set for the cart, then the order's items will be in the store's default locale, or in the original language of the products if no default locale is set.
