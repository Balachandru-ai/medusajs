...
[React Native](https://reactnative.dev/) is a framework for building native apps using React. [Expo](https://expo.dev/) is a framework and platform for universal React applications that makes it easy to build, deploy, and iterate on native iOS and Android apps.
