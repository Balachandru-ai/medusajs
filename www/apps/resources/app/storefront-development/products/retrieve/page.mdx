...
By default, product content, such as title and description, is returned in the store's default locale, falling back to the product's original content if no translation is available.
