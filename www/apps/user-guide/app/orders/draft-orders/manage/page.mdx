...
To use the Draft Orders features in the Medusa Admin, you must have the [Draft Orders Plugin](!resources!/commerce-modules/order/draft-orders) installed in your Medusa application. Your technical team should handle the plugin installation.
