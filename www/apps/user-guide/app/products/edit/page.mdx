...
As of [Medusa v2.13.0](https://github.com/medusajs/medusa/releases/tag/v2.13.0), product options can be managed globally and re-used across products. If you don't see the Product → Options page in the sidebar, request your technical team to [upgrade your Medusa application](!docs!/learn/update).
...
3. In the side window that opens, you can:
    ...
    - To create a new product option, create it in the [Product → Options](../options/page.mdx#create-a-product-option) page, then choose it in the "Product Options" dropdown.
