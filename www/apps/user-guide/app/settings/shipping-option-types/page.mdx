...
To view shipping option types in your store, go to Settings → Shipping Option Types. Here, you can see a list of all the shipping option types you have set up in your store. You can also search, filter, and sort the shipping option types to find the one you are looking for.
...
4. Once you're done, click the Create button at the bottom right.
