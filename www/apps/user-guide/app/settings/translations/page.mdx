...
Translations are available from [Medusa v2.13.0](https://github.com/medusajs/medusa/releases/tag/v2.13.0). If you don't see the locale settings in your Medusa Admin, request your technical team to [upgrade your Medusa application](!docs!/learn/update).
