 ...
 * description: Retrieve a list of locales. The locales can be filtered by fields such as `id`. The locales can also be sorted or paginated.
 * x-authenticated: true
 * parameters:
 *   - name: q
 *     in: query
 *     description: The locale's q.
 *     required: false
 *     schema:
 *       type: string
 *       title: q
